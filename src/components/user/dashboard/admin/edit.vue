<template>
    ...
    <Form class="mb-5" @submit="onSubmit" :validation-schema="ArticleSchema">
        ...
        <!-- 4-WYSIWYG  -->
        <div class="mb-4">
            <tibtapEditor @update="updateEditor" :content="article.editor" />
        ...
        <!-- 5-Rating -->
        <div class="mb-4">
            <Field name="rating" v-model="article.rating" value="Select a rating"
...
// ARTICLE STORE
import { useArticleStore } from '@/stores/articale';
